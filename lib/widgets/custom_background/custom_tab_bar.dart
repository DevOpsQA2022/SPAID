    ...
    return getValueForScreenType<bool>(
      ...
      desktop: true,
        ...
        ? Scaffold(
            ...
            // ) : Scaffold(backgroundColor: MyColors.white,body: child);
          )
        : child!;
  }
}
...
class CurvePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    paint.color = MyColors.kPrimaryColor2;
    ...
    paint.color = MyColors.kPrimaryColor1;
    canvas.drawPath(path, paint);
    ...
    paint.color = MyColors.kPrimaryColor;
    canvas.drawPath(path, paint);
  }
